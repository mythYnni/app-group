        ...
        <div class="row g-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="blog blog-primary d-flex align-items-center" style="padding: 0px 0px 15px 0px;">
                                <div class="flex-1 ms-3">
                                    <a href="{{ route('view_detail_group', $valueHistory['slugGroup']) }}"
                                        class="d-block title text-dark fw-medium">{{$valueHistory['nameGroup']}}</a>
                                    <span class="text-muted small">{{ $obj->account_group }} thành viên</span>
                                </div>
                            </div>
                            @endif
                            @endforeach
            ...
            <div class="col-lg-8 col-md-12">
                <div class="sidebar border-0">
                    ...
                    <h4 class="title mb-3 mt-3"><a href="{{ $obj->linkGroup }}" target="_blank"
                            style="color: rgb(253 13 13); font-weight: 700;" class="hover-h4">{{ $obj->nameGroup
                            }}</a></h4>
                        ...
                        <li class="list-inline-item px-3 py-2 shadow rounded text-start m-1 bg-white">
                            <div class="d-flex widget align-items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <small class="text-primary mb-0">{{ $obj->code }}</small>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="list-inline-item px-3 py-2 shadow rounded text-start m-1 bg-white">
                            <div class="d-flex widget align-items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <small class="text-primary mb-0">{{ number_format($obj->rent_cost, 0, ',', '.') }}
                                        vnđ / tháng</small>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="list-inline-item px-3 py-2 shadow rounded text-start m-1 bg-white">
                            <div class="d-flex widget align-items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <small class="text-primary mb-0">{{ number_format($obj->price, 0, ',', '.') }}
                                        vnđ</small>
                                </div>
                            </div>
                        </li>
            ...
            <div class="col-xl-12 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="job-post job-post-list rounded shadow p-3 mb-4 d-xl-flex align-items-center justify-content-between position-relative"
                    ...
                    <div
                        ...
                        <span class="d-flex fw-medium mt-md-2 mb-10px mb-md-2" style="font-size: 11.5px;">{{ $address
                            }}</span>
                    </div>
