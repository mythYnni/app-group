                ...
                <div class="card-body row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <select class="form-select" id="exampleSelect1" name="typeBlog">
                            ...
                            <option value="1">Tư Vấn Cá Nhân</option>
                            <option value="2">Tư Vấn Doanh Nghiệp</option>
                            <option value="3">Khóa Học Online</option>
                            <option value="4">Dịch Vụ Xây Nhóm</option>
                            <option value="5">Phát Triển Nhóm</option>
                            <option value="6">Tăng Thành Viên Nhóm</option>
                            <option value="7">Tăng Like/Follow Fanpage</option>
                            <option value="8">Dịch Vụ Facebook</option>
                            <option value="9">Thiết Kế Website</option>
                        </select>
                    </div>
                    <div class="form-group col-12">
                        ...
                        @enderror
                        <div class="form-group">
                            {{-- <textarea name="detail" id="editor">{{ old('detail') ?? 'Nội Dung Bài Viết' }}</textarea> --}}
                            <textarea class="form-control" rows="5" id="comment" name="detail">{{ old('detail') ?? 'Nội Dung Bài Viết' }}</textarea>
                        </div>
                    </div>
